...
import { NoteFormProps } from "../../../ts-types/ts-types";
    ...
    <Grid className={classes.noteInfo}>
      ...
      >
        ...
        <List className={classes.infoList}>
          <ToolItem handleClick={onPressTag} name="tag" classes={classes} />
          <ToolItem handleClick={onPressColor} name="color" classes={classes} />
          <ToolItem
        ...
        {showCategory ? (
          ...
          >
            ...
            {category.map(c => (
              <MenuItem key={c.id} value={c.categoryValue}>
                => {c.categoryValue}
              </MenuItem>
            ))}
          </TextField>
        ...
        {isChildCategory ? (
          ...
          >
            {category.map(item => (
              <MenuItem key={item.id} value={item.categoryValue}>
                {item.categoryValue}
              </MenuItem>
            ))}
          </TextField>
